...
export declare class Image {
     ...
     */
    constructor(width: number, height: number, data: Buffer, channels: number, id: string, colorMode?: ColorMode, pixelDensity?: {
        scaleX: number;
        scaleY: number;
    });
    /**
     ...
     */
    static fromRGBData(width: number, height: number, data: Buffer, channels: number, id: string): Image;
}
