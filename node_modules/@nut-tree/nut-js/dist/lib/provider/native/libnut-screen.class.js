    ...
    grabScreen() {
        return new Promise((resolve, reject) => {
            ...
            if (screenShot) {
                ...
                resolve(new image_class_1.Image(screenShot.width, screenShot.height, screenShot.image, 4, "grabScreenResult", colormode_enum_1.ColorMode.BGR, pixelScaling));
            }
            else {
    ...
    grabScreenRegion(region) {
        return new Promise((resolve, reject) => {
            ...
            if (screenShot) {
                ...
                resolve(new image_class_1.Image(screenShot.width, screenShot.height, screenShot.image, 4, "grabScreenRegionResult", colormode_enum_1.ColorMode.BGR, pixelScaling));
            }
            else {
                reject("Unable to fetch screen content.");
            }
