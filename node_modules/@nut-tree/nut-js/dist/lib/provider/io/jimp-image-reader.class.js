    ...
    load(parameters) {
        return new Promise((resolve, reject) => {
            jimp_1.default.read(parameters)
                ...
                resolve(new image_class_1.Image(jimpImage.bitmap.width, jimpImage.bitmap.height, jimpImage.bitmap.data, jimpImage.hasAlpha() ? 4 : 3, parameters, colormode_enum_1.ColorMode.BGR));
