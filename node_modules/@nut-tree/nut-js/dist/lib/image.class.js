...
class Image {
     ...
     */
    constructor(width, height, data, channels, id, colorMode = colormode_enum_1.ColorMode.BGR, pixelDensity = {
        scaleX: 1.0,
        scaleY: 1.0,
    }) {
        this.width = width;
    ...
    async toRGB() {
        ...
        return new Image(this.width, this.height, rgbImage.bitmap.data, this.channels, this.id, colormode_enum_1.ColorMode.RGB, this.pixelDensity);
    }
    /**
    ...
    async toBGR() {
        ...
        const rgbImage = (0, imageToJimp_function_1.imageToJimp)(this);
        return new Image(this.width, this.height, rgbImage.bitmap.data, this.channels, this.id, colormode_enum_1.ColorMode.BGR, this.pixelDensity);
    }
    /**
     * {@link fromRGBData} creates an {@link Image} from provided RGB data
     */
    static fromRGBData(width, height, data, channels, id) {
